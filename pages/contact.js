        ...
        <div>
            ...
            <div className="container">
                ...
                <div>
                    ...
                    <br />
                    <label className="form-label">Phone No.(Optional)</label>
                    <input type="number" placeholder="Enter your phone number here" onChange={(e) => setPhone(e.target.value)} className="form-control" />
